package com.hugovs.gls.receiver.util.mfcc;

public class MFCC {

    private final static int n_mfcc = 20;
    private final static double fMin = 0.0;
    private final static int n_fft = 99;
    private final static int hop_length = 33;
    ...
    private double[][] melFilter() {
        //Create a Filterbank matrix to combine mfcc bins into Mel-frequency bins.
        // Center freqs of each mfcc bin
